...
namespace MassEffectModder
{
    ...
    static class LODSettings
    {
        ...
        static public void updateLOD(MeType gameId, ConfIni engineConf, bool limit2k)
        {
            if (gameId == MeType.ME1_TYPE)
            {
                if (limit2k)
        ...
        static public void updateGFXSettings(MeType gameId, ConfIni engineConf, bool softShadowsME1, bool meuitmMode)
        {
            if (gameId == MeType.ME1_TYPE)
            {
                engineConf.Write("MaxShadowResolution", "4096", "Engine.Engine");
                engineConf.Write("MaxShadowResolution", "4096", "Engine.GameEngine");
                if (softShadowsME1)
                {
                    engineConf.Write("MinShadowResolution", "0", "Engine.Engine");
                    engineConf.Write("MinShadowResolution", "0", "Engine.GameEngine");
                }
                else
                {
                    engineConf.Write("MinShadowResolution", "0", "Engine.Engine");
